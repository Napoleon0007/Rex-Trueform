...
export default function CasinoStats() {
  ...
  const cells = [
    ...
    { label: 'Biggest win', value: `${data.biggestWin.toLocaleString()} ₿` },
    { label: 'Total won', value: `${data.won.toLocaleString()} ₿` },
    { label: 'Total wagered', value: `${data.wagered.toLocaleString()} ₿` },
